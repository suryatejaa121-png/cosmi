(function (_, D) {
  ...
  var ns = (_, D, g) =>
    D in _
      ? as(_, D, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (_[D] = g);
  var L = (_, D, g) => (ns(_, typeof D != "symbol" ? D + "" : D, g), g);
  let D = 0;
  function g() {
    if (!(D > 100)) {
      if (D === 100)
  ...
  class rt {
    constructor({
      ...
      if (
        ((this.gl = this.canvas.getContext("webgl2", v)),
        (this._isWebGL2 = !!this.gl),
        this.gl ||
          (this.gl =
            this.canvas.getContext("webgl", v) ||
            this.canvas.getContext("experimental-webgl", v)),
        this.gl)
      )
        this.onSuccess && this.onSuccess();
      else {
        this.production ||
          g(this.type + ": WebGL context could not be created"),
  ...
  class Ve {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      (this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = this.parent.type === "Plane" ? lt : ct),
        (this.defaultFsCode = this.parent.type === "Plane" ? dt : ut),
        s
          ? (this.vsCode = s)
          : (!this.renderer.production &&
...
`,
    ...
    createUniforms(e) {
      (this.uniformsManager = new ot(this.renderer, this.program, e)),
        this.setUniforms();
    }
    setUniforms() {
  ...
  class Z {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = B),
        (r[11] = 0),
        (r[12] = e.x + Y - (q * Y + S * U + $ * V)),
        (r[13] = e.y + U - (b * Y + x * U + ie * V)),
        (r[14] = e.z + V - (P * Y + I * U + B * V)),
        (r[15] = 1),
        this
      );
    }
  ...
  class w {
    ...
    clone() {
      return new w(this._x, this._y, this._z);
    }
    sanitizeNaNValuesWith(e) {
      return (
        (this._x = isNaN(this._x) ? e.x : parseFloat(this._x)),
...
gl.LINEAR filtering will be used instead`
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? Me.set(this._parent.scale.x, this._parent.scale.y)
          : Me.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Me.set(0.001, 0.001)),
    ...
    _updateTextureMatrix(e) {
      ...
      (t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = gt.setFromArray([
          t.x,
          0,
          0,
          0,
  ...
  class _t {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (o = parseInt(o)),
        (l = parseInt(l)),
        (this._geometry = new ft(this.renderer, { width: o, height: l })),
    ...
    _initMesh() {
      (this.uuid = Ee()),
        (this.loader = new mt(this.renderer, this, {
          sourcesLoaded: 0,
          initSourcesToLoad: 0,
          complete: !1,
          onComplete: () => {
...
`,
  ...
  class He extends yt {
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Pt.set(0.001, 0.001)),
      ...
      if (s.length === 1)
        s[0] === 0
          ? ((t[0] = this._getIntersection(
              t[1],
              N.set(0.95, 1, 0).applyMat4(i)
            )),
            t.push(
              this._getIntersection(t[3], H.set(-1, -0.95, 0).applyMat4(i))
            ))
          : s[0] === 1
          ? ((t[1] = this._getIntersection(
            ...
            t.push(
              this._getIntersection(t[2], H.set(1, -0.95, 0).applyMat4(i))
            ))
          : s[0] === 2
          ...
          : s[0] === 3 &&
            ...
            t.push(
              this._getIntersection(t[0], H.set(-1, 0.95, 0).applyMat4(i))
            ));
      else if (s.length === 2)
        s[0] === 0 && s[1] === 1
          ? ((t[0] = this._getIntersection(
              t[3],
              N.set(-1, -0.95, 0).applyMat4(i)
            )),
            (t[1] = this._getIntersection(
              t[2],
              H.set(1, -0.95, 0).applyMat4(i)
            )))
          : s[0] === 1 && s[1] === 2
          ? ((t[1] = this._getIntersection(
              t[0],
        ...
        (t = [t[r]]),
          r === 0
            ? (t.push(
                this._getIntersection(t[0], N.set(-0.95, 1, 0).applyMat4(i))
              ),
              t.push(
                this._getIntersection(t[0], H.set(-1, 0.95, 0).applyMat4(i))
              ))
    ...
    mouseToPlaneCoords(e) {
      if (
        ...
        Ne.equals(this.quaternion) && Mt.equals(this.transformOrigin))
      )
  ...
  class zt extends He {
    constructor(
      ...
      this.renderer.scene.removePlane(this),
        ...
        this.renderer.scene.addPlane(this),
        (this.readPass = new Ae(e, {
          depth: !1,
          clear: !1,
          texturesOptions: p,
        })),
        (this.writePass = new Ae(e, {
          depth: !1,
          clear: !1,
          texturesOptions: p,
        })),
  ...
  typeof document.hidden < "u"
    ? ((be = "hidden"), (de = "visibilitychange"))
    : typeof document.msHidden < "u"
    ? ((be = "msHidden"), (de = "msvisibilitychange"))
    : typeof document.webkitHidden < "u" &&
      ((be = "webkitHidden"), (de = "webkitvisibilitychange"));
  function Lt(n, e) {
    let t;
    return function (...s) {
      clearTimeout(t),
  ...
  function Fe(n, e, t, s, i) {
    if (t.length > 1) {
      ...
      if (
        (i === "linear" &&
          (d = n.createLinearGradient(a - c, h - u, a + c, h + u)),
        i === "conic")
      ) {
  ...
  function Ge(n) {
    ...
    if (
      typeof n == "string" &&
      (n.includes("=>") || n.includes("function") || n.includes("x"))
    ) {
  ...
  function oe(n) {
    ...
    const e =
      ...
      t =
        n.states &&
        [...n.states.appear, ...n.states.scroll, ...n.states.hover].length > 0,
  ...
  function Dt(n, e, t) {
    ...
    return (
      n.forEach((i) => {
        switch (i.layerType) {
          case "text":
            s.push(new Yt(i, e, null, t).unpackage());
            break;
          case "image":
  ...
  function Ot(n, e) {
    ...
    (s.src = pe(
      ...
      (s.alt = pe("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
  ...
  function je(n, e) {
    ...
    c.setAttribute("data-us-text", n.local.id),
      (c.style.cssText = `width:${t}px;top:${h}px;left:${o}px;font-size:${i}px;line-height:${r}px;letter-spacing:${a}px;font-family:${
        n.fontFamily
      };font-weight:${n.fontWeight};text-align:${
        n.textAlign
  ...
  function Xe() {
    _.scenes.forEach((n, e) => {
      document.body.contains(n.element) ||
        (n.curtain && n.curtain.dispose(), _.scenes.splice(e, 1));
    });
  }
  function Vt(n) {
    return (
      n &&
      n.renderer &&
      n.renderer.nextRender &&
      typeof n.renderer.nextRender.execute == "function"
    );
  }
  function Ie() {
    ...
    const e = (t) => {
      ...
      n.forEach((i) => {
        ...
        (!ce || t - ce > 64) &&
          ...
          (ce = t),
          (ne > 1e3 || (ne < 0 && !ke && !G)) && Le()),
        s ? (qt(), (ue = requestAnimationFrame(e))) : cancelAnimationFrame(ue);
    };
    n.length && (ue = requestAnimationFrame(e));
  }
  function me(n, e, t) {
    return (n == null ? void 0 : n.type) === "Vec3" &&
      (e == null ? void 0 : e.type) === "Vec3"
      ? {
          type: "Vec3",
          x: n._x + (e._x - n._x) * t,
          y: n._y + (e._y - n._y) * t,
      ...
      : (n == null ? void 0 : n.type) === "Vec2" &&
        (e == null ? void 0 : e.type) === "Vec2"
      ? {
          type: "Vec2",
          x: n._x + (e._x - n._x) * t,
          y: n._y + (e._y - n._y) * t,
  ...
  function Te(n, e) {
    return (
      n.type === "Vec2"
        ? (n = new k(n._x, e ? 1 - n._y : n._y))
        : n.type === "Vec3" && (n = new w(n._x, n._y, n._z)),
      n
    );
  }
  function Re(n, e, t) {
  ...
  function Ye(n, e, t) {
    if (Pe) {
      n.loadImage(Pe, { sampler: "uTexture" });
      return;
    }
  ...
  class Bt {
    constructor({
      ...
      (this.prop = e),
        ...
        (this.uniformData = a),
        (this.value = Te(t)),
        (this.endValue = s !== void 0 ? Te(s || 0) : null),
      ...
      return (
        ...
        this.progress === 0
          ...
          : (a >= 1 && ((this.complete = !0), (this.progress = 0)),
            (this.lastTick = s),
            this.complete ? !1 : me(this.value, e, this.progress))
      );
    }
    resetState() {
      (this.progress = 0),
  ...
  class Wt {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= G), this.mode === "scrollIntoView")) {
        ...
        return (
          this.lastTick !== void 0 &&
            (o = we(o, this.lastTick, this.momentum * 2)),
          this.lastTick !== void 0 && Math.abs(this.lastTick - o) < fe
            ? !1
            : ((this.lastTick = o), me(e, this.value, o))
        );
        ...
        return (
          ...
          this.lastTick !== void 0 &&
          ((r = we(r, this.lastTick, this.momentum * 2)), Math.abs(r) < fe)
            ? !1
  ...
  class Nt {
    ...
    updateEffect(e, t, s) {
      ...
      if (e === void 0) return !1;
      const i =
          (u = s == null ? void 0 : s.getParent) == null ? void 0 : u.call(s),
        r = performance.now();
      if (this.triggerOnElement && ((s != null && s.isElement) || i)) {
        let f = (i || s).isHovered();
        f && !this.lastEnterTime
          ? (t = r)
          : f
          ? (t = this.lastEnterTime)
          : (t = null);
      }
      const a = t === null,
      ...
      return (
        ...
        !t && !c
          ...
          : (!t &&
            ...
            (this.lastTick = r),
            (this.lastEnterTime = t),
            c ? me(e, this.value, this.progress) : !1)
      );
    }
    resetState() {
      this.progress = 0;
      ...
      n.forEach((e) => {
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === "Vec2"
            ...
            ? (e.props[i] = new w(e.props[i]._x, e.props[i]._y, e.props[i]._z))
  ...
  class $e {
    constructor(e, t) {
      ...
      (this.locked = e.locked || !1),
        ...
        (this.breakpoints = Ht(e.breakpoints || [])),
        (this.local.sceneId = t),
        (this.local.id = ge()),
        (this.states = {
          appear:
            e.states && e.states.appear
              ? e.states.appear.map((s) => new Bt(s))
              : [],
          scroll:
            e.states && e.states.scroll
              ? e.states.scroll.map((s) => new Wt(s))
              : [],
          hover:
            e.states && e.states.hover
              ? e.states.hover.map((s) => new Nt(s))
              : [],
        });
    }
    state() {
      return (
        _.scenes.find((e) => e.id === this.local.sceneId) || this.initOptions
      );
    }
    getIndex() {
      return this.state()
    ...
    getPlane() {
      var e, t, s;
      return (s =
        (t = (e = this.state()) == null ? void 0 : e.curtain) == null
          ? void 0
          : t.planes) == null
        ? void 0
        : s.find(
            (i) => i.type !== "PingPongPlane" && i.userData.id === this.local.id
          );
    }
    getPlanes() {
      var e, t, s;
      return (
        ((s =
          ...
          : s.filter(
              (i) =>
                i.type !== "PingPongPlane" && i.userData.id === this.local.id
            )) || []
      );
    }
    getMaskedItem() {
    ...
    updateStateEffects() {
      var i, r, a, h;
      if (
        !this.states.appear.some((o) => !o.complete) &&
      ...
      (!this.local.cachedBreakpoint ||
        this.local.cachedBreakpoint !==
          ((a = e.currentBreakpoint) == null ? void 0 : a.name)) &&
        (this.local.cachedBreakpoint =
          (h = e.currentBreakpoint) == null ? void 0 : h.name);
      const s = (o) =>
        !o.breakpoints || o.breakpoints.length === 0
          ? !0
          : o.breakpoints.find((l) => l === this.local.cachedBreakpoint);
      e.isInView &&
        (this.local.createdAt === null && (this.local.createdAt = t),
        this.states.appear.forEach((o) => {
          if (!s(o)) return;
          let l = o.startTime || this.local.createdAt;
          if (!o.initialized) {
            const c = [
              ...this.states.appear.filter((u) => u.prop === o.prop),
            ].sort(
              (u, f) => (u.transition.delay || 0) - (f.transition.delay || 0)
            )[0];
            (c == null ? void 0 : c.id) === o.id &&
              ((this.local.uniformUpdatesPool[o.prop] = o.value),
              (this.local.hasUpdates = !0),
              this.local.updatedProps.add(o.prop)),
              (o.initialized = !0),
              l || (o.startTime = t);
          }
          e != null &&
            e.pauseTime &&
            (l += Math.abs(e == null ? void 0 : e.pauseTime));
          const d = o.updateEffect(this[o.prop], l);
          d !== !1 &&
            ((this.local.uniformUpdatesPool[o.prop] = d),
            (this.local.hasUpdates = !0),
            this.local.updatedProps.add(o.prop)),
            this.isElement &&
              o.complete &&
              this.removeStateEffectProperty(o.prop);
        })),
        this.states.hover.forEach((o) => {
          if (!s(o)) return;
          const l = o.updateEffect(this[o.prop], e.mouse.enterTime, this);
          l !== !1 &&
            ((this.local.uniformUpdatesPool[o.prop] = l),
            (this.local.hasUpdates = !0),
            this.local.updatedProps.add(o.prop));
        }),
        ...
        this.local.hasUpdates &&
          (this.getPlanes().forEach((o) => {
            var l;
            for (let d of this.local.updatedProps) {
              const c = this.local.uniformUpdatesPool[d];
              c !== void 0 &&
                ((l = o.uniforms[d]) == null ? void 0 : l.lastValue) !== c &&
                (o.uniforms[d] && Re(c, o.uniforms[d], d),
                this.updateStateEffectProperty(d, c));
            }
          }),
          this.isElement &&
  ...
  let ze = class extends $e {
    ...
    resize() {
      ...
      this.render(),
        this.layerType === "text" && je(this, this.state().element);
    }
    dispose() {
      this.local.canvas &&
    ...
    isHovered() {
      ...
      return (
        h.x * 2 >= t && h.x * 2 <= t + i && h.y * 2 >= s && h.y * 2 <= s + r
      );
    }
  };
  class Gt extends ze {
    ...
    unpackageType() {
      return (
        (this.fill = ee(this.fill)),
        (this.stroke = ee(this.stroke)),
        this.render(),
        this
      );
    }
    render() {
      ...
      let l =
          ((m = this.local.stateEffectProps) == null
            ? void 0
            : m.borderRadius) ?? this.borderRadius,
        d =
          ((T = this.local.stateEffectProps) == null
            ? void 0
            : T.strokeWidth) ?? this.strokeWidth,
        c =
          ((R = this.local.stateEffectProps) == null
            ? void 0
            : R.gradientAngle) ?? this.gradientAngle,
        u =
          ((v = this.local.stateEffectProps) == null ? void 0 : v.rotation) ??
          this.rotation,
        f = i - o.x * a,
        p = r - o.y * h;
      if (
        ...
        if (
          ...
          this.type === "circle"
            ...
            : this.type === "polygon" &&
              this.drawPolygon(t, Math.abs(a), Math.abs(h), this.numSides);
        t.fillStyle = Fe(t, this.box(), this.fill, c, this.gradientType);
      }
      t.fill(),
      ...
      for (let t in this)
        this[t] &&
          ...
          (this[t].type === "Vec2"
            ...
            : this[t].type === "Vec3" &&
              (this[t] = new w(this[t]._x, this[t]._y, this[t]._z)));
      return this;
    }
    getParent() {
      return this.state()
  ...
  class Xt extends ze {
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        const u = le(this.anchorPoint),
          f =
            (((c = this.local.stateEffectProps) == null
              ? void 0
        ...
        t.translate(v, E),
          t.rotate(f),
          t.drawImage(this.local.img, -T, -R, a, h),
          t.restore();
      }
    }
    render() {}
  ...
  class Yt extends ze {
    ...
    unpackage() {
      return (
        (this.fill = ee(this.fill)), (this.effects = ee(this.effects)), this
      );
    }
    loadFont() {
      var o;
    ...
    getAbsoluteFontValues(t) {
      var h, o, l, d, c, u;
      const s =
          ((o = (h = this.local) == null ? void 0 : h.stateEffectProps) == null
            ? void 0
    ...
    render() {
      ...
      const a = le(this.anchorPoint),
        h =
          ((q = (V = this.local) == null ? void 0 : V.stateEffectProps) == null
            ? void 0
      ...
      let o = this.state(),
        ...
        R = /^\d+$/.test(this.fontStyle) ? this.fontStyle : "400";
      t.clearRect(0, 0, o.canvasWidth, o.canvasHeight),
        (t.font = `${T} ${R} ${f}px/${p}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
        this.isSafari ||
          ((t.textAlign = this.textAlign), (t.letterSpacing = m + "px"));
      const v = t.measureText("m").width;
      (r = Math.max(r, v)), t.save();
      let E = d + r / 2,
        M = c + l / 2;
      t.translate(E, M),
      ...
      const A = (b, P, S, x, I, $, ie) => {
          let B = P.split("").reduce(
              (z, K, rs) =>
                z + b.measureText(K).width + (rs < P.length - 1 ? I : 0),
              0
            ),
            W;
          if (
            ($ === "center" ? (W = S + (ie - B) / 2 - ie / 2) : (W = S),
            $ === "right")
          )
            for (let z = P.length - 1; z >= 0; z--) {
              const K = P[z];
              (W -= b.measureText(K).width),
                b.fillText(K, W, x),
                z > 0 && (W -= I);
            }
          else
            for (let z = 0; z < P.length; z++)
              b.fillText(P[z], W, x), (W += b.measureText(P[z]).width + I);
        },
        F = (b, P) => {
          let S = c + p * P + p / 2 + f / 3;
          this.isSafari
            ? A(t, b, d, S, m, this.textAlign, r)
            : t.fillText(b, d, S);
        },
        y = this.textContent
...
`)
      ...
      const Y = (b, P, S) =>
        P.split("").reduce(
          (I, $, ie) => (
            (I += b.measureText($).width), ie < P.length - 1 && (I += S), I
          ),
          0
        );
      for (let b = 0; b < O; b++) {
        ...
        for (let x = 0; x < S.length; x++) {
          const I = S[x],
            $ = P + I;
          if (
            (this.isSafari && m ? Y(t, $, m) : t.measureText($).width) > r ||
            I ===
              `
`
          ) {
            if (P !== "")
              (y[b] = P.trim()),
                x !== S.length - 1
                  ? (y.splice(b + 1, 0, S.slice(x).join("")), O++)
                  : I !==
                      `
` && y.push(I);
            else {
              ...
              for (; B.length > 0; ) {
                ...
                for (
                  let K = 0;
                  K < B.length &&
                  (t.measureText(z + B[K]).width <= r || K == 0);
                  K++
                )
                  z += B[K];
                (B = B.slice(z.length)),
                  (y[W] = z.trim()),
                  B.length > 0 && (y.splice(W + 1, 0, B), W++, O++);
              }
              S.slice(x + 1).length > 0 && (y[W] += S.slice(x + 1).join(""));
            }
            break;
          } else P = $;
          x === S.length - 1 && (y[b] = P.trim());
        }
      }
      y.forEach((b, P) => {
        F(b, u), P < y.length - 1 && u++;
      }),
  ...
  function Qe(n, e, t = 50) {
    const s = e || n.getBoundingClientRect(),
      i =
        (s.top >= -t && s.top <= re + t) ||
        (s.bottom >= -t && s.bottom <= re + t) ||
        (s.top <= 0 && s.bottom >= re),
      r =
        (s.left >= -t && s.left <= J + t) ||
        (s.right >= -t && s.right <= J + t) ||
        (s.left <= 0 && s.right >= J);
    return i && r;
  }
  function Le() {
        ...
        (n.scrollY = G),
          n.lastBbox &&
            (Math.abs(e.top - n.lastBbox.top) === 0 && ne > 0
              ? ((n.fixedCounter = (n.fixedCounter || 0) + 1),
                n.fixedCounter > 3 && (n.isFixed = !0))
              : (n.fixedCounter = 0)),
          (n.lastBbox = n.bbox),
          (n.bbox = e);
      });
    ...
    (!ce || s - ce > 64) && Le(),
      e.forEach((i) => {
        Qe(i.element, i.bbox, 100)
          ? i.isInView ||
            ((i.isInView = !0),
            (i.pauseTime = i.pauseTime - s),
            i.curtain.resize(),
            i.lazyLoad &&
              !i.initialized &&
              !i.initializing &&
              i.initializePlanes())
          : i.isInView && ((i.isInView = !1), (i.pauseTime = s));
      });
  }
  function qt() {
    let n = performance.now();
    _.scenes.forEach((e) => {
      ...
      if (
        ...
        s.find((o) => o.uniforms.mousePos) &&
        !(
          (ve() &&
            (r = (i = e.interactivity) == null ? void 0 : i.mouse) != null &&
            r.disableMobile) ||
          ((h = (a = e.interactivity) == null ? void 0 : a.mouse) != null &&
            h.disabled)
        )
      ) {
        ...
        e.mouse.page.y < e.lastBbox.height + o
  ...
  function Se(n) {
    ...
    _.scenes
      .filter((t) => t.isInView && t.initialized)
      .forEach((t) => {
        let s = t.bbox;
        Math.abs(ne) > 1 &&
          e - t.lastBboxTime > 64 &&
        ...
        n.targetTouches
          ...
          t.isFixed &&
            ((t.scrollY = 0),
            n.targetTouches
              ? (r = n.targetTouches[0].clientY)
              : (r = n.clientY));
        const a = i - s.left,
          h = r - (s.top + (t.isFixed ? 0 : G));
        (t.mouse.page.x = i),
          (t.mouse.page.y = r),
          (t.mouse.movePos.x = a * 0.5),
          (t.mouse.movePos.y = h * 0.5),
  ...
  class Qt {
    ...
    preloadTextures() {
      this.layers.forEach((e) => {
        ...
        if (e.isElement)
          ...
          ((i =
            (s = e == null ? void 0 : e.data) == null ? void 0 : s.texture) !=
            null &&
            i.src)
        ) {
          const c =
              ...
              ((h =
                ...
                : h.src),
            u =
              ((o = e == null ? void 0 : e.texture) == null
                ? void 0
                : o.sampler) ||
              ((d =
          ...
          this.local.preloadedTextures[c]
            ...
            : ((this.local.preloadedTextures[c] = { count: 1, texture: null }),
              this.textureLoader.loadImage(
                c,
                { sampler: u, premultipliedAlpha: !1 },
                (f) => {
        ...
        this.layers.forEach((e) => {
          ...
          (t = e.states) == null || t.scroll.forEach((i) => i.resetState()),
            (s = e.states) == null ||
              s.appear.forEach((i) => {
                e[i.prop] =
                  i.endValue ?? e.local.stateEffectProps[i.prop] ?? e[i.prop];
              }),
              ...
              e.local.bpProps &&
                Object.keys(e.local.bpProps).forEach((i) => {
                  e.getPlanes().forEach((r) => {
                    r.uniforms[i] && Re(e.local.bpProps[i], r.uniforms[i], i);
                  });
                })),
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((h) => oe(h)).length;
        for (; s && !oe(s) && !r && !a; )
          t++,
            (s = e[t]),
            s &&
    ...
    getRenderTargets() {
      ...
      return (e = this.curtain) == null
        ? void 0
        : e.renderTargets.filter((t) => t.userData.id);
    }
    getPlanes() {
      var e;
      return (e = this.curtain) == null
    ...
    getPlaneParams(e, t) {
      ...
      if (
        (e.states &&
          [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(
            (u) => {
              i[u.prop] ||
                (u.uniformData &&
                  ((i[u.prop] = u.uniformData), (i[u.prop].value = e[u.prop])));
            }
          ),
        ...
        for (let u in e.data.uniforms) {
          ...
          (i[u] = e.data.uniforms[u]),
            ((d = f.value) == null ? void 0 : d.type) === "Vec3"
              ? (i[u].value = new w(f.value._x, f.value._y, f.value._z))
              : ((c = f.value) == null ? void 0 : c.type) === "Vec2"
              ? (i[u].value = new k(f.value._x, f.value._y))
              : typeof f.value == "object" && (i[u].value = ee(f.value));
        }
      return {
        fragmentShader: r,
        vertexShader: a,
    ...
    createPlane(e, t, s) {
      ...
      try {
        ...
        if (
          (h &&
            ((o = typeof h == "number" ? h : 0.5), (o *= this.renderingScale)),
          e.userDownsample &&
            typeof e.userDownsample == "number" &&
            (o *= e.userDownsample),
      ...
      let i = this.getPlaneParams(
        ...
        r =
          (a = this.curtain) == null
            ...
            : a.planes.find(
                (h) =>
                  h.type === "PingPongPlane" && h.userData.id === e.local.id
              );
      if (r) r.setRenderOrder(t);
      else {
        if (((r = new zt(this.curtain, this.curtain.container, i)), !r)) return;
        (r.userData.id = e.local.id),
          (r.userData.pingpong = !0),
          r.setRenderOrder(t),
          r
            .onReady(() => {
              this.setInitialEffectPlaneUniforms(r, e, e.getParent(), s),
      ...
      if (
        ([t.texture, (i = t.data) == null ? void 0 : i.texture]
          ...
          .forEach((r) => {
            var h;
            if (
              (h = t.compiledFragmentShaders[s.passIndex ?? 0]) == null
                ? void 0
                : h.includes(r.sampler)
            ) {
              const o = this.local.preloadedTextures[r.src];
              o != null && o.texture
                ? (o.count > 1
                    ? (X(e, r.sampler, o.texture), o.count--)
                    : e.addTexture(o.texture),
    ...
    handleEffectPlane(e, t, s) {
      ...
      let r = this.getRenderTargets()[t - 1],
        a =
          (o = this.curtain) == null
            ...
            : o.planes.find(
                (l) =>
                  l.type === "PingPongPlane" && l.userData.id === e.local.id
              ),
      ...
      if (
        (a &&
          ...
          X(i, "uPingPongTexture", a.getTexture()),
        r
          ? X(i, "uTexture", r.getTexture())
          : Ye(i, this.canvasWidth, this.canvasHeight),
    ...
    handleElementPlane(e, t) {
      ...
      if (
        ...
        a &&
          (X(s, "uBgTexture", a.getTexture()),
          o && e.mask && X(s, "uPreviousLayerTexture", o.getTexture()));
      }
    }
    handleChildEffectPlane(e, t, s) {
      ...
      let a = this.getRenderTargets()[t - 1],
        h =
          (f = this.curtain) == null
            ...
            : f.planes.find(
                (p) =>
                  p.type === "PingPongPlane" && p.userData.id === e.local.id
              ),
      ...
      if (
        ...
        h &&
          ...
          X(i, "uPingPongTexture", h.getTexture()),
        ...
        if (d && s.length > 1) {
          ...
          r.preloadedCanvasTexture.userData.used
            ...
            : ((r.preloadedCanvasTexture._samplerName = "uBgTexture"),
              i.addTexture(r.preloadedCanvasTexture));
      e.type === "custom" && X(i, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(i, e, s);
    }
    createPlanes() {
    ...
    assignRenderTargetToPlane(e, t, s, i) {
      let r = this.getTextureParams(e, t, s),
        a = this.getRenderTargets()[t] || new Ae(this.curtain, r);
        ...
        for (let a in e.uniforms)
          ((r = t.states) != null && r.scroll.some((h) => h.prop === a)) ||
            (t.local.bpProps && a in t.local.bpProps
              ? Re(t.local.bpProps[a], e.uniforms[a], a)
              : a in t && Re(t[a], e.uniforms[a], a));
        s &&
          i &&
          i.index < i.length - 1 &&
          e.uniforms.isMask &&
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      let d = i / t,
        c = 1 - r / s;
      if (!l) return { x: h ? d : 0.5, y: o ? c : 0.5 };
      if (!e.local.lastMousePos)
        return (
          (e.local.lastMousePos = { x: h ? d : 0.5, y: o ? c : 0.5 }),
    ...
    setEffectPlaneUniforms(e, t) {
      var r, a, h;
      let s =
        ((r = t.local.stateEffectProps) == null ? void 0 : r.speed) ??
        t.speed ??
        1;
      if (
        (t.animating &&
          e.uniforms.time &&
          (e.uniforms.time.value += (s * 60) / this.fps),
        ve() &&
          (h = (a = this.interactivity) == null ? void 0 : a.mouse) != null &&
          h.disableMobile)
      )
        return !1;
    ...
    getTextureParams(e, t, s) {
      ...
      return (
        i.userData.downSample &&
          (r =
            typeof i.userData.downSample == "number"
              ? i.userData.downSample
              : 0.5),
        {
    ...
    waitForAssetsAndDisablePlanes() {
      this.layers.some(
        (t) =>
          ((t.layerType === "image" || t.layerType === "text") &&
            !t.local.loaded) ||
  ...
  function Jt() {
    te(window, "scroll", Ze),
      ve() ? te(window, "touchmove", Se) : te(window, "mousemove", Se),
      te(window, "routeChange", Xe),
      te(document, "mouseleave", Je),
      (he = Lt($t, 16)),
      ve() ? te(window, "orientationchange", he) : te(window, "resize", he),
      te(document, de, qe),
      (Ce = !0);
  }
  function De() {
    se(window, "mousemove", Se),
      se(window, "touchmove", Se),
      se(window, "scroll", Ze),
      se(window, "routeChange", Xe),
      se(document, "mouseleave", Je),
    ...
    if (t) {
      ...
      if (a)
        try {
          ...
          return (
            s(new Error(`Error parsing JSON from ${t}: ${h.message}`)),
            Promise.reject()
          );
        }
    } else {
      ...
      ts(e, t, n.filePath, i, n.production)
        .then((r) => {
          ...
          const a = r.options || {},
            h = Zt(n.element)
              ? n.element
              : document.getElementById(n.elementId);
          if (!h) {
            i(
              new Error(
          ...
          const c = Dt(r.history, o, Kt(h, l, d)),
            u = new Qt({
              id: o,
              fps: n.fps || a.fps || 60,
              dpi: d,
          ...
          (u.curtain.canvas.innerText = n.altText || ""),
            u.curtain.canvas.setAttribute(
              "aria-label",
              n.ariaLabel || "Unicorn Studio Scene"
            ),
            u.curtain.canvas.setAttribute("role", "img");
          let f = a[pe("ZnJlZVBsYW4=")];
          (f || a[pe("aW5jbHVkZUxvZ28=")]) && Ot(o, h),
            f && console.log(pe("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
            _.scenes.push(u),
            (u.layers = c),
            u.preloadTextures(),
          ...
          const t = [
            ...
            s =
              typeof window < "u" && window.requestIdleCallback
                ...
                : (i) => setTimeout(i, 0);
          t.filter((i) => !i.getAttribute("data-us-initialized")).forEach(
            (i, r) => {
              i.setAttribute("data-us-initialized", !0),
                s(() => {
                  const a = j(i, "data-us-project"),
                    h = j(i, "data-us-project-src"),
                    o = j(i, "data-us-disablemobile"),
                    l = j(i, "data-us-disablemouse");
                  Ke({
                    projectId: h ? null : a,
                    filePath: h,
                    element: i,
                    dpi: +j(i, "data-us-dpi"),
                    scale: +j(i, "data-us-scale"),
                    production: j(i, "data-us-production"),
                    fps: +j(i, "data-us-fps"),
                    lazyLoad: j(i, "data-us-lazyload"),
                    altText: j(i, "data-us-alttext"),
                    ariaLabel: j(i, "data-us-arialabel"),
                    fixed: j(i, "data-us-fixed"),
                    interactivity:
                      o || l
                        ? { mouse: { disableMobile: o, disabled: l } }
                        : null,
                  }).then((d) => {
                    r === t.length - 1 && n(_.scenes);
                  });
                });
            }
          );
